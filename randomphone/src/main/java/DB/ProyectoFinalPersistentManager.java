...
public class ProyectoFinalPersistentManager extends PersistentManager {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(DB.Persona.class);
		configuration.addAnnotatedClass(DB.Cliente.class);
		configuration.addAnnotatedClass(DB.Comercial.class);
		configuration.addAnnotatedClass(DB.Servicio.class);
		configuration.addAnnotatedClass(DB.Movil.class);
		configuration.addAnnotatedClass(DB.Fijo.class);
		configuration.addAnnotatedClass(DB.Fibra.class);
		configuration.addAnnotatedClass(DB.Television.class);
		configuration.addAnnotatedClass(DB.Paquete.class);
		configuration.addAnnotatedClass(DB.Canal.class);
		configuration.addAnnotatedClass(DB.Incidencia.class);
		configuration.addAnnotatedClass(DB.Factura.class);
		configuration.addAnnotatedClass(DB.Administrador.class);
		configuration.addAnnotatedClass(DB.Terminal.class);
